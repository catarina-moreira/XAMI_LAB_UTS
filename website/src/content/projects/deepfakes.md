...
- Robust deepfake detection across modalities (image, video, audio) and generation methods
- Cross-domain generalization of detection models against unseen manipulation techniques
- Multimodal approaches to detecting fake and manipulated news content
- Explainable detection: producing human-understandable evidence for why media is judged synthetic
- Understanding how fake content spreads and changes beliefs, and how explanations can counter it
- Evaluation protocols and benchmarks for deepfake detection systems
